...
def seed_sample_graph_rfis(db: Session) -> None:
    ...
    rows += _rfi(
        ...
        question="SAMPLE: Confirm beam seat elevation on E-101 Rev A at grid B-4.",
        priority="standard",
        assigned="Sample AE",
    ...
    rows += _rfi(
        ...
        number=2,
        status="ball_in_court",
        subject="Due soon — hoist opening framing on E-101",
        question="SAMPLE: Confirm hoist opening header on E-101 Rev A.",
        priority="urgent",
    ...
    rows += _rfi(
        ...
        official_response="SAMPLE: Use the lintel shown on E-101 Rev A. An answer is not a CO.",
        rev_id=REV_E101_A_ID,
        sheet_number="E-101",
        revision="A",
        pin=(0.22, 0.44),
    ...
    rows += _rfi(
        ...
        official_response="SAMPLE: Landing thickness as drawn on E-101 Rev A. Not a change order.",
        rev_id=REV_E101_A_ID,
        sheet_number="E-101",
        revision="A",
        pin=(0.48, 0.22),
