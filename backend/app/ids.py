...
HARBOR_CALENDAR_ID = UUID("aaaaaaaa-0000-4000-8000-000000000012")
HARBOR_HOLIDAY_LABOR_2026_ID = UUID("aaaaaaaa-0000-4000-8000-000000000013")
HARBOR_HOLIDAY_VETERANS_2026_ID = UUID("aaaaaaaa-0000-4000-8000-000000000014")
HARBOR_HOLIDAY_THANKS_2026_ID = UUID("aaaaaaaa-0000-4000-8000-000000000015")
...
ILSB_CALENDAR_ID = UUID("aaaaaaaa-0000-4000-8000-000000000112")
ILSB_HOLIDAY_LABOR_2026_ID = UUID("aaaaaaaa-0000-4000-8000-000000000113")
ILSB_HOLIDAY_VETERANS_2026_ID = UUID("aaaaaaaa-0000-4000-8000-000000000114")
ILSB_HOLIDAY_THANKS_2026_ID = UUID("aaaaaaaa-0000-4000-8000-000000000115")
...
USER_ILSB_AF_ID = UUID("aaaaaaaa-0000-4000-8000-000000000331")
USER_ILSB_FM_ID = UUID("aaaaaaaa-0000-4000-8000-000000000332")
USER_ILSB_JM_ID = UUID("aaaaaaaa-0000-4000-8000-000000000333")
USER_ILSB_AP_ID = UUID("aaaaaaaa-0000-4000-8000-000000000334")

HARBOR_AREA_YARD_ID = UUID("aaaaaaaa-0000-4000-8000-000000000401")
HARBOR_AREA_ROOF_ID = UUID("aaaaaaaa-0000-4000-8000-000000000402")
ILSB_AREA_L07_ID = UUID("aaaaaaaa-0000-4000-8000-000000000411")

HARBOR_TICKET_ID = UUID("aaaaaaaa-0000-4000-8000-000000000451")
